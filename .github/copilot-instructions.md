...
Every slice requires appropriate unit, real OS/filesystem integration, contract, security, performance-budget, and manual UI/install/upgrade tests. Run all repository lint/static/type/unit/integration/E2E/package validation. Self-review races, deadlocks, leaks, disposal, retries, lifecycle, permissions, interrupted operations and rollback before completion.
